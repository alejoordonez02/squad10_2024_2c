...
Feature: Consulta de costos de empleados
 ...
 Scenario: Successfully view total cost of hours worked by an employee
    ...
    And the employee "John Doe" has logged 160 hours in the month "2024-11"
  ...
  Scenario: View total cost of hours worked by all employees in a period
    ...
    When I request the total cost of hours worked by all employees in the period "2024-11"
  ...
  Scenario: View cost of worked hours by employee for a specific project
    Given I am a operations manager in the system
    And the employee "Jane Smith" has logged 40 hours for "Project A" in the month "2024-11"
    And "Jane Smith" has a salary of $25 per hour
    When I request the total cost of hours worked for "Jane Smith" on "Project A" for the month "2024-11"
  ...
  Scenario: View total cost of hours worked by a team
    Given I am a operations manager in the system
    And multiple employees have logged hours for "Project B" in the month "2024-11"
    When I request the total cost of hours worked by the team for "Project B" in the month "2024-11"
  ...
  Scenario: View total cost of worked hours by the team for a month
    Given I am a operations manager in the system
    And multiple employees have logged hours in the month "2024-11"
    When I request the total cost of hours worked by the team for the month "2024-11"
  ...
  Scenario: View cost of worked hours with date range filter
    ...
    Then the system should display the total cost of hours worked by "John Doe" as $1,600